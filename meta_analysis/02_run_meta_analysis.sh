...
config_file=${basedir}/config/meta_config10_grch37.tsv
...
mkdir -p $basedir/new_simulations/meta_analysis_mamba${suffix} && cd $_
...
--out-format "$basedir/new_simulations/meta_analysis_mamba${suffix}/meta.pheno%d.config%d.tsv" \
--plink-path $basedir/plink_new
